			...
			{tabs.map((tab) => {
				...
				return (
					<Link
						key={tab.name}
						href={`${tab.href}#menu`}
						className={`-mb-[2px] border-b-4 px-1 py-3 text-center font-serif text-[14px] font-bold tracking-wide whitespace-nowrap uppercase transition-colors duration-200 sm:px-2 sm:text-sm md:py-4 md:text-xl ${
							isActive
