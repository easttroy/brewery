			...
			<section className="mx-auto w-full max-w-4xl px-4 py-20">
				<div className="border-etbrew-gold prose prose-stone max-w-none border-t-4 bg-white p-8 shadow-xl md:p-16">
					<p>
						...
						visit or make a purchase from etbrew.com (the
						&ldquo;Site&rdquo;).
					</p>
					...
					<ul className="list-disc space-y-2 pl-6 text-stone-700">
						<li>
							<strong>&ldquo;Cookies&rdquo;</strong> are data
							files that are placed on your device or computer and
							often include an anonymous unique identifier. For
							more information about cookies, and how to disable
							cookies, visit{" "}
							<a
						...
						<li>
							<strong>&ldquo;Log files&rdquo;</strong> track
							actions occurring on the Site, and collect data
							including your IP address, browser type, Internet
							service provider, referring/exit pages, and
							date/time stamps.
						</li>
						<li>
							<strong>
								&ldquo;Web beacons,&rdquo; &ldquo;tags,&rdquo;
								and &ldquo;pixels&rdquo;
							</strong>{" "}
							are electronic files used to record information
					...
					<p className="mt-6">
						...
						(including credit card numbers), email address,
						birthday, and phone number. We refer to this information
						as &ldquo;Order Information.&rdquo;
					</p>

					<p>
						When we talk about &ldquo;Personal Information&rdquo; in
					...
					<p>
						...
						above. For example, we use MailChimp to power our email
						marketing — you can read more about how MailChimp uses
					...
					<p>
						...
						information from children under 18. If you are a parent
						or guardian and you are aware that your child has
						provided us with Personal Information, please contact
						us. If we discover that a child under 18 has provided us
						with Personal Information, we will delete such
					...
					<p className="font-bold">
						2905 Main St, East Troy, WI, 53120, United States
					</p>
				</div>
			</section>
		</div>
